...
def main():
    ...
    # Load the pruned FP32 model
    fp32_model = load_fp32_model("models/resnet18_pruned.pth")
    fp32_model.eval()
    ...
    torch.save(int8_model, "models/resnet18_pruned_int8.pth")
    print("Quantized model saved as models/resnet18_pruned_int8.pth")
