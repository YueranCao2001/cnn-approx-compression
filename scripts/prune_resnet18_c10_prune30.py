...
def apply_global_pruning(model, amount=0.3):
    ...
    amount: fraction of weights to prune (0.3 = prune 30%).
    """
    parameters_to_prune = []
...
def main(prune_amount=0.3, epochs=5):
    ...
    save_path = "models/resnet18_c10_pruned30.pth"
    torch.save(model.state_dict(), save_path)
    print(f"\n✓ 30% pruned model saved to {save_path}")
