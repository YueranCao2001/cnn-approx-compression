...
PREFIX = "mobilenetv2_c10_prune50_fp32"

EXPERIMENT_FOOTER = (
    "Model: MobileNetV2 · Dataset: CIFAR-10 · "
...
def plot_scatter_accuracy_size(accuracy_pct, size_mb, labels, filename):
    ...
    plt.ylabel("Accuracy (%)")
    plt.title("Accuracy vs Model Size\nMobileNetV2 · CIFAR-10 · 50% pruning (FP32)")
...
def main():
    print("Collecting CIFAR-10 MobileNetV2 metrics ...")
    ...
    print("Generating CIFAR-10 MobileNetV2 plots...")
    ...
    print("Done! MobileNetV2 plots saved in 'results/'.")
